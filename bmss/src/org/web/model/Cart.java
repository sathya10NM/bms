...
@Entity
@Table(name = "bms_cart")
@TableGenerator(name = "cart_tab_gen", allocationSize = 1, initialValue = 100, catalog = "test", table = "cart_table_gen", pkColumnName = "name", valueColumnName = "value", pkColumnValue = "cid")
public class Cart {
	@Id
	@GeneratedValue(generator = "cart_tab_gen", strategy = GenerationType.TABLE)
